...
#############################
#'''
#Please restart the runtime after installing repos/packages
#'''
#
## -*- coding: utf-8 -*-
##"""CSC420_Project_MultiSlam.ipynb
...
#
#'''
#Please restart runtime before executing this cell
#'''
...
args = {
    ...
    # 'leftcam': '/media/saqibman/MSFiles/video/model_train_track_trim.mp4',
    # 'leftcam': 'video/car_racetrack_480p.mp4',
    # 'leftcam': '/media/saqibman/MSFiles/video/driving_country_480p_trimmed.mp4',
    #  'leftcam': '/media/saqibman/MSFiles/video/driving_city_480p.mp4',
      # 'leftcam': 'video/right_turn.mp4',
    #   'leftcam': 'video/kittbw.mp4',
    ...
    'endframe': 1450,              # Total number of video frames to process. None = All
    'ip': '0.0.0.0',
    'port': '8000',
}
